                           ...
                           void **decoded)
{
  ...
  do {
    partial_flags = cast(amqp_flags_t)D_16(encoded, offset);
    offset += 2;
  ...
  switch (class_id) {
    case 50: {
      amqp_queue_properties_t *p = cast(amqp_queue_properties_t *) amqp_pool_alloc(pool, amqp_queue_properties_t.sizeof);
      (*p)._flags = flags;
      *decoded = p;
      return 0;
    }
    case 90: {
      amqp_tx_properties_t *p = cast(amqp_tx_properties_t *) amqp_pool_alloc(pool, amqp_tx_properties_t.sizeof);
      (*p)._flags = flags;
      *decoded = p;
      return 0;
    }
    case 80: {
      amqp_stream_properties_t *p = cast(amqp_stream_properties_t *) amqp_pool_alloc(pool, amqp_stream_properties_t.sizeof);
      (*p)._flags = flags;
    ...
    case 40: {
      amqp_exchange_properties_t *p = cast(amqp_exchange_properties_t *) amqp_pool_alloc(pool, amqp_exchange_properties_t.sizeof);
      (*p)._flags = flags;
      *decoded = p;
      return 0;
    }
    case 110: {
      amqp_tunnel_properties_t *p = cast(amqp_tunnel_properties_t *) amqp_pool_alloc(pool, amqp_tunnel_properties_t.sizeof);
      (*p)._flags = flags;
    ...
    case 30: {
      amqp_access_properties_t *p = cast(amqp_access_properties_t *) amqp_pool_alloc(pool, amqp_access_properties_t.sizeof);
      (*p)._flags = flags;
      *decoded = p;
      return 0;
    }
    case 10: {
      amqp_connection_properties_t *p = cast(amqp_connection_properties_t *) amqp_pool_alloc(pool, amqp_connection_properties_t.sizeof);
      (*p)._flags = flags;
      *decoded = p;
      return 0;
    }
    case 100: {
      amqp_dtx_properties_t *p = cast(amqp_dtx_properties_t *) amqp_pool_alloc(pool, amqp_dtx_properties_t.sizeof);
      (*p)._flags = flags;
      *decoded = p;
      return 0;
    }
    case 70: {
      amqp_file_properties_t *p = cast(amqp_file_properties_t *) amqp_pool_alloc(pool, amqp_file_properties_t.sizeof);
      (*p)._flags = flags;
    ...
    case 60: {
      amqp_basic_properties_t *p = cast(amqp_basic_properties_t *) amqp_pool_alloc(pool, amqp_basic_properties_t.sizeof);
      (*p)._flags = flags;
    ...
    case 120: {
      amqp_test_properties_t *p = cast(amqp_test_properties_t *) amqp_pool_alloc(pool, amqp_test_properties_t.sizeof);
      (*p)._flags = flags;
      *decoded = p;
      return 0;
    }
    case 20: {
      amqp_channel_properties_t *p = cast(amqp_channel_properties_t *) amqp_pool_alloc(pool, amqp_channel_properties_t.sizeof);
      (*p)._flags = flags;
      *decoded = p;
      return 0;
    }
                       ...
                       amqp_bytes_t encoded)
{
  ...
  switch (methodNumber) {
    case AMQP_QUEUE_DECLARE_METHOD: {
      amqp_queue_declare_t *m = cast(amqp_queue_declare_t *) decoded;
    ...
    case AMQP_QUEUE_DECLARE_OK_METHOD: {
      amqp_queue_declare_ok_t *m = cast(amqp_queue_declare_ok_t *) decoded;
      E_8(encoded, offset, (*m).queue.len);
      offset++;
      E_BYTES(encoded, offset, (*m).queue.len, (*m).queue.bytes);
      offset += (*m).queue.len;
    ...
    case AMQP_QUEUE_BIND_METHOD: {
      amqp_queue_bind_t *m = cast(amqp_queue_bind_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).queue.len);
      offset++;
    ...
    case AMQP_QUEUE_PURGE_METHOD: {
      amqp_queue_purge_t *m = cast(amqp_queue_purge_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).queue.len);
      offset++;
    ...
    case AMQP_QUEUE_PURGE_OK_METHOD: {
      amqp_queue_purge_ok_t *m = cast(amqp_queue_purge_ok_t *) decoded;
      E_32(encoded, offset, (*m).message_count);
      offset += 4;
      return offset;
    }
    case AMQP_QUEUE_DELETE_METHOD: {
      amqp_queue_delete_t *m = cast(amqp_queue_delete_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).queue.len);
      offset++;
    ...
    case AMQP_QUEUE_DELETE_OK_METHOD: {
      amqp_queue_delete_ok_t *m = cast(amqp_queue_delete_ok_t *) decoded;
      E_32(encoded, offset, (*m).message_count);
      offset += 4;
      return offset;
    }
    case AMQP_QUEUE_UNBIND_METHOD: {
      amqp_queue_unbind_t *m = cast(amqp_queue_unbind_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).queue.len);
      offset++;
    ...
    case AMQP_STREAM_QOS_METHOD: {
      amqp_stream_qos_t *m = cast(amqp_stream_qos_t *) decoded;
    ...
    case AMQP_STREAM_CONSUME_METHOD: {
      amqp_stream_consume_t *m = cast(amqp_stream_consume_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).queue.len);
      offset++;
    ...
    case AMQP_STREAM_CONSUME_OK_METHOD: {
      amqp_stream_consume_ok_t *m = cast(amqp_stream_consume_ok_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_STREAM_CANCEL_METHOD: {
      amqp_stream_cancel_t *m = cast(amqp_stream_cancel_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_STREAM_CANCEL_OK_METHOD: {
      amqp_stream_cancel_ok_t *m = cast(amqp_stream_cancel_ok_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_STREAM_PUBLISH_METHOD: {
      amqp_stream_publish_t *m = cast(amqp_stream_publish_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).exchange.len);
      offset++;
    ...
    case AMQP_STREAM_RETURN_METHOD: {
      amqp_stream_return_t *m = cast(amqp_stream_return_t *) decoded;
    ...
    case AMQP_STREAM_DELIVER_METHOD: {
      amqp_stream_deliver_t *m = cast(amqp_stream_deliver_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_EXCHANGE_DECLARE_METHOD: {
      amqp_exchange_declare_t *m = cast(amqp_exchange_declare_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).exchange.len);
      offset++;
    ...
    case AMQP_EXCHANGE_DELETE_METHOD: {
      amqp_exchange_delete_t *m = cast(amqp_exchange_delete_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).exchange.len);
      offset++;
    ...
    case AMQP_TUNNEL_REQUEST_METHOD: {
      amqp_tunnel_request_t *m = cast(amqp_tunnel_request_t *) decoded;
      table_result = amqp_encode_table(encoded, &((*m).meta_data), &offset);
      if (table_result < 0) return table_result;
      return offset;
    }
    case AMQP_ACCESS_REQUEST_METHOD: {
      amqp_access_request_t *m = cast(amqp_access_request_t *) decoded;
    ...
    case AMQP_ACCESS_REQUEST_OK_METHOD: {
      amqp_access_request_ok_t *m = cast(amqp_access_request_ok_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      return offset;
    }
    case AMQP_CONNECTION_START_METHOD: {
      amqp_connection_start_t *m = cast(amqp_connection_start_t *) decoded;
    ...
    case AMQP_CONNECTION_START_OK_METHOD: {
      amqp_connection_start_ok_t *m = cast(amqp_connection_start_ok_t *) decoded;
    ...
    case AMQP_CONNECTION_SECURE_METHOD: {
      amqp_connection_secure_t *m = cast(amqp_connection_secure_t *) decoded;
    ...
    case AMQP_CONNECTION_SECURE_OK_METHOD: {
      amqp_connection_secure_ok_t *m = cast(amqp_connection_secure_ok_t *) decoded;
      E_32(encoded, offset, (*m).response.len);
      offset += 4;
      E_BYTES(encoded, offset, (*m).response.len, (*m).response.bytes);
      offset += (*m).response.len;
    ...
    case AMQP_CONNECTION_TUNE_METHOD: {
      amqp_connection_tune_t *m = cast(amqp_connection_tune_t *) decoded;
    ...
    case AMQP_CONNECTION_TUNE_OK_METHOD: {
      amqp_connection_tune_ok_t *m = cast(amqp_connection_tune_ok_t *) decoded;
      E_16(encoded, offset, (*m).channel_max);
      offset += 2;
      E_32(encoded, offset, (*m).frame_max);
      offset += 4;
    ...
    case AMQP_CONNECTION_OPEN_METHOD: {
      amqp_connection_open_t *m = cast(amqp_connection_open_t *) decoded;
    ...
    case AMQP_CONNECTION_OPEN_OK_METHOD: {
      amqp_connection_open_ok_t *m = cast(amqp_connection_open_ok_t *) decoded;
    ...
    case AMQP_CONNECTION_REDIRECT_METHOD: {
      amqp_connection_redirect_t *m = cast(amqp_connection_redirect_t *) decoded;
    ...
    case AMQP_CONNECTION_CLOSE_METHOD: {
      amqp_connection_close_t *m = cast(amqp_connection_close_t *) decoded;
      E_16(encoded, offset, (*m).reply_code);
      offset += 2;
      E_8(encoded, offset, (*m).reply_text.len);
      offset++;
    ...
    case AMQP_DTX_START_METHOD: {
      amqp_dtx_start_t *m = cast(amqp_dtx_start_t *) decoded;
    ...
    case AMQP_FILE_QOS_METHOD: {
      amqp_file_qos_t *m = cast(amqp_file_qos_t *) decoded;
      E_32(encoded, offset, (*m).prefetch_size);
      offset += 4;
      E_16(encoded, offset, (*m).prefetch_count);
      offset += 2;
    ...
    case AMQP_FILE_CONSUME_METHOD: {
      amqp_file_consume_t *m = cast(amqp_file_consume_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).queue.len);
      offset++;
    ...
    case AMQP_FILE_CONSUME_OK_METHOD: {
      amqp_file_consume_ok_t *m = cast(amqp_file_consume_ok_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_FILE_CANCEL_METHOD: {
      amqp_file_cancel_t *m = cast(amqp_file_cancel_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_FILE_CANCEL_OK_METHOD: {
      amqp_file_cancel_ok_t *m = cast(amqp_file_cancel_ok_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_FILE_OPEN_METHOD: {
      amqp_file_open_t *m = cast(amqp_file_open_t *) decoded;
    ...
    case AMQP_FILE_OPEN_OK_METHOD: {
      amqp_file_open_ok_t *m = cast(amqp_file_open_ok_t *) decoded;
    ...
    case AMQP_FILE_PUBLISH_METHOD: {
      amqp_file_publish_t *m = cast(amqp_file_publish_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).exchange.len);
      offset++;
    ...
    case AMQP_FILE_RETURN_METHOD: {
      amqp_file_return_t *m = cast(amqp_file_return_t *) decoded;
      E_16(encoded, offset, (*m).reply_code);
      offset += 2;
      E_8(encoded, offset, (*m).reply_text.len);
      offset++;
    ...
    case AMQP_FILE_DELIVER_METHOD: {
      amqp_file_deliver_t *m = cast(amqp_file_deliver_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_FILE_ACK_METHOD: {
      amqp_file_ack_t *m = cast(amqp_file_ack_t *) decoded;
      E_64(encoded, offset, (*m).delivery_tag);
      offset += 8;
      bit_buffer = 0;
    ...
    case AMQP_FILE_REJECT_METHOD: {
      amqp_file_reject_t *m = cast(amqp_file_reject_t *) decoded;
      E_64(encoded, offset, (*m).delivery_tag);
      offset += 8;
      bit_buffer = 0;
    ...
    case AMQP_BASIC_QOS_METHOD: {
      amqp_basic_qos_t *m = cast(amqp_basic_qos_t *) decoded;
      E_32(encoded, offset, (*m).prefetch_size);
      offset += 4;
      E_16(encoded, offset, (*m).prefetch_count);
      offset += 2;
    ...
    case AMQP_BASIC_CONSUME_METHOD: {
      amqp_basic_consume_t *m = cast(amqp_basic_consume_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).queue.len);
      offset++;
    ...
    case AMQP_BASIC_CONSUME_OK_METHOD: {
      amqp_basic_consume_ok_t *m = cast(amqp_basic_consume_ok_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_BASIC_CANCEL_METHOD: {
      amqp_basic_cancel_t *m = cast(amqp_basic_cancel_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_BASIC_CANCEL_OK_METHOD: {
      amqp_basic_cancel_ok_t *m = cast(amqp_basic_cancel_ok_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_BASIC_PUBLISH_METHOD: {
      amqp_basic_publish_t *m = cast(amqp_basic_publish_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).exchange.len);
      offset++;
    ...
    case AMQP_BASIC_RETURN_METHOD: {
      amqp_basic_return_t *m = cast(amqp_basic_return_t *) decoded;
      E_16(encoded, offset, (*m).reply_code);
      offset += 2;
      E_8(encoded, offset, (*m).reply_text.len);
      offset++;
    ...
    case AMQP_BASIC_DELIVER_METHOD: {
      amqp_basic_deliver_t *m = cast(amqp_basic_deliver_t *) decoded;
      E_8(encoded, offset, (*m).consumer_tag.len);
      offset++;
      E_BYTES(encoded, offset, (*m).consumer_tag.len, (*m).consumer_tag.bytes);
      offset += (*m).consumer_tag.len;
    ...
    case AMQP_BASIC_GET_METHOD: {
      amqp_basic_get_t *m = cast(amqp_basic_get_t *) decoded;
      E_16(encoded, offset, (*m).ticket);
      offset += 2;
      E_8(encoded, offset, (*m).queue.len);
      offset++;
    ...
    case AMQP_BASIC_GET_OK_METHOD: {
      amqp_basic_get_ok_t *m = cast(amqp_basic_get_ok_t *) decoded;
      E_64(encoded, offset, (*m).delivery_tag);
      offset += 8;
      bit_buffer = 0;
      if ((*m).redelivered) { bit_buffer |= (1 << 0); }
    ...
    case AMQP_BASIC_GET_EMPTY_METHOD: {
      amqp_basic_get_empty_t *m = cast(amqp_basic_get_empty_t *) decoded;
    ...
    case AMQP_BASIC_ACK_METHOD: {
      amqp_basic_ack_t *m = cast(amqp_basic_ack_t *) decoded;
      E_64(encoded, offset, (*m).delivery_tag);
      offset += 8;
      bit_buffer = 0;
      if ((*m).multiple) { bit_buffer |= (1 << 0); }
    ...
    case AMQP_BASIC_REJECT_METHOD: {
      amqp_basic_reject_t *m = cast(amqp_basic_reject_t *) decoded;
      E_64(encoded, offset, (*m).delivery_tag);
      offset += 8;
      bit_buffer = 0;
      if ((*m).requeue) { bit_buffer |= (1 << 0); }
    ...
    case AMQP_BASIC_RECOVER_METHOD: {
      amqp_basic_recover_t *m = cast(amqp_basic_recover_t *) decoded;
      bit_buffer = 0;
      if ((*m).requeue) { bit_buffer |= (1 << 0); }
      E_8(encoded, offset, bit_buffer);
      offset++;
    ...
    case AMQP_TEST_INTEGER_METHOD: {
      amqp_test_integer_t *m = cast(amqp_test_integer_t *) decoded;
    ...
    case AMQP_TEST_INTEGER_OK_METHOD: {
      amqp_test_integer_ok_t *m = cast(amqp_test_integer_ok_t *) decoded;
      E_64(encoded, offset, (*m).result);
      offset += 8;
      return offset;
    }
    case AMQP_TEST_STRING_METHOD: {
      amqp_test_string_t *m = cast(amqp_test_string_t *) decoded;
    ...
    case AMQP_TEST_STRING_OK_METHOD: {
      amqp_test_string_ok_t *m = cast(amqp_test_string_ok_t *) decoded;
    ...
    case AMQP_TEST_TABLE_METHOD: {
      amqp_test_table_t *m = cast(amqp_test_table_t *) decoded;
    ...
    case AMQP_TEST_TABLE_OK_METHOD: {
      amqp_test_table_ok_t *m = cast(amqp_test_table_ok_t *) decoded;
    ...
    case AMQP_TEST_CONTENT_OK_METHOD: {
      amqp_test_content_ok_t *m = cast(amqp_test_content_ok_t *) decoded;
      E_32(encoded, offset, (*m).content_checksum);
      offset += 4;
      return offset;
    }
    case AMQP_CHANNEL_OPEN_METHOD: {
      amqp_channel_open_t *m = cast(amqp_channel_open_t *) decoded;
    ...
    case AMQP_CHANNEL_FLOW_METHOD: {
      amqp_channel_flow_t *m = cast(amqp_channel_flow_t *) decoded;
      bit_buffer = 0;
    ...
    case AMQP_CHANNEL_FLOW_OK_METHOD: {
      amqp_channel_flow_ok_t *m = cast(amqp_channel_flow_ok_t *) decoded;
      bit_buffer = 0;
      if ((*m).active) { bit_buffer |= (1 << 0); }
      E_8(encoded, offset, bit_buffer);
      offset++;
    ...
    case AMQP_CHANNEL_ALERT_METHOD: {
      amqp_channel_alert_t *m = cast(amqp_channel_alert_t *) decoded;
      E_16(encoded, offset, (*m).reply_code);
      offset += 2;
      E_8(encoded, offset, (*m).reply_text.len);
      offset++;
    ...
    case AMQP_CHANNEL_CLOSE_METHOD: {
      amqp_channel_close_t *m = cast(amqp_channel_close_t *) decoded;
      E_16(encoded, offset, (*m).reply_code);
      offset += 2;
      E_8(encoded, offset, (*m).reply_text.len);
      offset++;
                           ...
                           amqp_bytes_t encoded)
{
  ...
  amqp_flags_t flags = * cast(amqp_flags_t *) decoded; /* cheating! */
  ...
  switch (class_id) {
    ...
    case 80: {
      amqp_stream_properties_t *p = cast(amqp_stream_properties_t *) decoded;
      if (flags & AMQP_STREAM_CONTENT_TYPE_FLAG) {
    ...
    case 110: {
      amqp_tunnel_properties_t *p = cast(amqp_tunnel_properties_t *) decoded;
      if (flags & AMQP_TUNNEL_HEADERS_FLAG) {
        table_result = amqp_encode_table(encoded, &((*p).headers), &offset);
        if (table_result < 0) return table_result;
      }
    ...
    case 70: {
      amqp_file_properties_t *p = cast(amqp_file_properties_t *) decoded;
      if (flags & AMQP_FILE_CONTENT_TYPE_FLAG) {
        E_8(encoded, offset, (*p).content_type.len);
        offset++;
        E_BYTES(encoded, offset, (*p).content_type.len, (*p).content_type.bytes);
    ...
    case 60: {
      amqp_basic_properties_t *p = cast(amqp_basic_properties_t *) decoded;
      if (flags & AMQP_BASIC_CONTENT_TYPE_FLAG) {
        E_8(encoded, offset, (*p).content_type.len);
        offset++;
        E_BYTES(encoded, offset, (*p).content_type.len, (*p).content_type.bytes);
